...
export const ProductForm = (props)=>{
    ...
    const saveProductData=async (formInput)=>{
        const product={
           product_name:formInput.productName,
           product_price:formInput.productPrice,
           product_image:formInput.productImage,
           product_description:formInput.productDescription,
        }
        const message=await axios.post("htttp://localhost:3000/course/add",product,{
           headers:{
